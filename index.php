        ...
        <?php
            ...
            if(isset($_GET['code'])) {
                ...
                if(!isset($token["error"])){
                    ...
                    $stmt = $conn->prepare("SELECT 'google_id' FROM 'users' WHERE 'google_id' = '$id'");
                    $stmt->execute();
                   ...
                   // if(mysqli_num_rows($get_user) > 0){
                        ...
                        $sql = "INSERT INTO 'users'('google_id','name','email','profile_image') VALUES('$id','$full_name','$email','$profile_pic')";
                        $conn->execute($sql);                       
            ...
            <div class="login_img">
                <a class="login-btn" href="<?php echo $client->createAuthUrl(); ?>">
                        <img alt="Sign in with Google" src="assets/imgs/google.png" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                        <noscript><img src="assets/imgs/google.png" alt="Sign in with Google"></noscript>
                </a>
            </div>
